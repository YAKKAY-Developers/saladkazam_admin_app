...
import { encrypt, getRouterUrls, LoginRequest, LoginResponse } from "src/app/typings";
...
export class AuthGuard implements CanActivate, CanActivateChild, CanLoad {
  ...
  canActivate(
    ...
    // return true;
    // this.router.navigate(["auth/signin"]);
    console.log("LoginRequest.data",LoginRequest);
    if (
      ...
      console.log(routerUrls.MyAccount + routerUrls.Login);
      this.router.navigate(["auth/signin"]);
